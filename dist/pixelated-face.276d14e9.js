...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"script/pixelated-face.js":[function(require,module,exports) {
...
const pixelateFace = ({
  ...
  faceContext.drawImage(webcam, // source
  details.x, // start of source pull
  details.y, details.width, details.height, details.x, // start of drawing x,y
  details.y, SIZE, //how wide?
  SIZE);
  let {
    width,
    height
  ...
  width *= SCALE;
  height *= SCALE; //draw a smaller face but scalling it up to create the  "pixelated" effect

  faceContext.drawImage(faceCanvas, details.x, details.y, SIZE, SIZE, details.x - (width - details.width) / 2, details.y - (height - details.height) / 2, width, height);
};
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","script/pixelated-face.js"], null)
//# sourceMappingURL=/pixelated-face.276d14e9.js.map